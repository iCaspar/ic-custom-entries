...
class PostTypes {
	...
	private function build_labels( array $post_type_names ) {
		...
		return [
			...
			'add_new'               => sprintf( '%s %s', __( 'Add New', ICASPAR_HUB_TEXT_DOMAIN ), $singular ),
			...
			'new_item'              => sprintf( '%s %s', __( 'New', ICASPAR_HUB_TEXT_DOMAIN ), $singular ),
			...
			'archives'              => sprintf( '%s %s', $singular, __( 'Archives', ICASPAR_HUB_TEXT_DOMAIN ) ),
			'insert_into_item'      => sprintf( '%s %s', __( 'Insert into', ICASPAR_HUB_TEXT_DOMAIN ), $singular ),
			'uploaded_to_this_item' => sprintf( '%s %s', __( 'Upload to this', ICASPAR_HUB_TEXT_DOMAIN ), $singular ),
